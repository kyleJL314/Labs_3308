...
$(document).ready(function() {
  ...
  $.ajax({url:url, dataType:"jsonp"}).then(function(data) {
    ...
    */
    //document.getElementById("image_today") = data.Current.weather_icons;
    ...
    var element = '';
    for(var i=0;i<5;i++){
    var dayData = getKey(i);
    var CardTitle=dayOfWeek;
    var tempHigh=dayData.maxtemp;
    var tempLow=dayData.mintemp;
    var sunriseTime=dayData.astro.sunrise;
    var sunsetTime=dayData.astro.sunset;
    element += '<div style="width: 20%;"> <div class="card"> <div class="card-body">\
    <h5 class="card-title">'+CardTitle+'</h5>\
            <p class="card-text">High:'+tempHigh+' <br>\
              Low: '+tempLow+'<br>\
    ...
    document.getElementById('5_day_forecast').innerHTML = element;
