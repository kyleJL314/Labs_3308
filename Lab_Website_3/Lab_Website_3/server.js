...
app.get('/home/pick_color', function(req, res) {
    ...
    .then(info => {
    	res.render('pages/home',{
				...
				color_msg:info[0].color_msg // Return the color message
			})
    })
    .catch(err => {
            console.log('error', err);
...
app.post('/home/pick_color', function(req, res) {
    ...
    .then(info => {
    	res.render('pages/home',{
				...
				color: info[0].hex_vaule,// Return the hex value of the color added to the table
				color_msg: info[0].color_msg // Return the color message of the color added to the table
			})
    })
    .catch(err => {
            console.log('error', err);
...
app.get('/team_stats', function(req, res) {
    ...
    .catch(err => {
        // display error message in case an error
            console.log('error', err);
            res.render('team_stats/page_name',{
			    my_title: "Page Title Here",
			    data: '',
			    wins: '',
                losses: '',
